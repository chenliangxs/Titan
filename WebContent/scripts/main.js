(function() {
  ...
  function init() {
    ...
    document.querySelector('#register').addEventListener('click', showRegistration);
    document.querySelector('#registration-btn').addEventListener('click', register);
    validateSession();
  ...
  //register
  function register() {
	  var username = document.querySelector('#new_username').value;
	  var password = document.querySelector('#new_password').value;
	  var firstname = document.querySelector('#new_firstname').value;
	  var lastname = document.querySelector('#new_lastname').value;
	  password = md5(username + md5(password));
  ...
  function showRegistrationError() {
	    document.querySelector('#registration-error').innerHTML = 'Invalid username, please try a new one.';
  }
